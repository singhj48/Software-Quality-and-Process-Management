 ...
 * @author Toshiba
 */
public class ECS_Track extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel3.setText("Check Submission Status");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ECS_Track.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
